...
#ifndef VIVECONTROLLER_H
#define VIVECONTROLLER_H

#include <rtm/idl/BasicDataTypeSkel.h>
#include <rtm/idl/ExtendedDataTypesSkel.h>
#include <rtm/idl/InterfaceDataTypesSkel.h>
#include <rtm\idl\CameraCommonInterfaceStub.h>
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  VIVEController(RTC::Manager* manager);
 ...
 protected:
  ...
  Img::TimedCameraImage m_hmdImage;
  /*!
   */
  InPort<Img::TimedCameraImage> m_hmdImageIn;
...
extern "C"
{
  DLL_EXPORT void VIVEControllerInit(RTC::Manager* manager);
};

#endif // VIVECONTROLLER_H
